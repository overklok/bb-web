...
-   Display popups for voltage lines and currents
-   Refactored board_info generation for Core API
-   Restructured layers
-   Added VoltageLayer
-   Added PopupLayer
-   Added Popup, CurrenPopup, VoltagePopup

## [1.2.15] - 2022-08-25

### Changed

-   HomeView UI/UX for courses / lessons
-   Lesson/mission/exercise stats for HomeView
...
-   task*description*\* fields will not be interpreted
