...
export default class RGBPlate extends Plate {
    ...
    private _drawLabel(size = Plate.LabelFontSizePreferred) {
        ...
        this._group
            ...
            .center(
                cells[0].center_rel.x,
                cells[0].rel.y + cells[0].size.y - size / 1.5
            );
        ...
        this._group
            ...
            .center(
                cells[1].center_rel.x,
                cells[1].rel.y + cells[1].size.y - size / 1.5
            );
        ...
        this._group
            ...
            .center(
                cells[2].center_rel.x,
                cells[2].rel.y + cells[2].size.y - size / 1.5
            );
        ...
        this._group
            ...
            .center(
                cells[3].center_rel.x,
                cells[3].rel.y + cells[3].size.y - size / 1.5
            );
