...
export default class RelayPlate extends LinearPlate {
    ...
    protected _drawPicture(qs = Plate.QuadSizePreferred) {
        ...
        for (let i = 0; i < 5; i++) {
            let cell = this.__grid.getCell(i, 0);
        ...
        paths[2] = this._group
            .polyline([
                ...
                [
                    cells[2].center_rel.x + cells_32x_one_thirds,
                    cells[2].center_rel.y
                ],
                [
