...
describe('Grid', function() {
    ...
    describe("#cells", function() {
        it("Should give correct amount of Cell items immediately after instantiating a grid", function() {
            let cells = Instance_Default.cells;

            expect(cells).to.have.lengthOf(GRID_COL_QTY);
            expect(cells).to.have.all.values.lengthOf(GRID_ROW_QTY);

            expect(cells).to.have.all.values.be.a('Cell');
        });
        
        it("Should give an array of Cell items with correct positions", function () {
