 ...
 * @subcategory Layers
 */
export default class ContactLayer extends Layer {
    /** CSS class of the layer */
    static Class = "bb-layer-contact";
    ...
    /** SVG group for event handling */
    private _hovergroup: SVG.Container;
    ...
    constructor(
        ...
        this._container.addClass(ContactLayer.Class);
     ...
     */
    public compose() {
        const hoverrect = this._hovergroup
            .rect()
            .width("99%")
        ...
        if (this._debug) {
            this._debug_text = this._hovergroup
    ...
    private _initGroups() {
        ...
        this._hovergroup = this._container.group();
    ...
    private _attachHandlers() {
        ...
        this._hovergroup.on("mousemove", (evt: MouseEvent) => {
    ...
    private _drawDomainLine(
        ...
        if (this.__detailed) {
            ...
            bias_x = is_horizontal ? 0 : ContactLayer.DomainSchematicBias;
            bias_y = is_vertical ? 0 : ContactLayer.DomainSchematicBias;
    ...
    private _drawDomainLineNotches(
        ...
        for (let pos = pos_from; pos <= pos_to; pos++) {
            ...
            let bias_x = is_horizontal ? 0 : ContactLayer.DomainSchematicBias;
            let bias_y = is_vertical ? 0 : ContactLayer.DomainSchematicBias;
    ...
    private _drawAuxPointUsb(
        ...
        this._drawAuxPointUsbPath(p_vcc, ContactLayer.DomainSchematicBias);
        this._drawAuxPointUsbPath(p_gnd, ContactLayer.DomainSchematicBias);
