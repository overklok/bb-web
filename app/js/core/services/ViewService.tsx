...
export default class ViewService extends IViewService {
    ...
    private views: typeof View[];
    private view_composer: typeof React.Component;
    private view_connector: ViewConnector;

    public setup(view_composer: typeof React.Component, views: typeof View[]) {
        this.views = views;
    ...
    public compose(element: HTMLElement) {
        ...
        const children = view_types.map((SpecificView: typeof View, index) => {
            return <SpecificView
