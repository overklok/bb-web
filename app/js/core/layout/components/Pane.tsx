...
// 4. С помощью параметра (size_min) пользователь задаёт минимальное соотношение или размер панели.
//  4.1. Если size_min не задан, минимальный размер панели принимается равным нулю.
//  4.2. Если в качестве size задано соотношение (%):
//      4.2.1. При соотношении (%) в size_min:
//          4.2.1.1. Если size - соотношение (%), size_min:
//              4.2.1.1.1. не должно превышать size для несвободных под-панелей
//              4.2.1.1.2. не должно превышать для всех под-панелей в сумме 100% (если size - соотношение)
//          4.2.1.2. Если size - размер (PX), size_min:
//              4.2.1.2.1. не может быть
//      4.2.2. При размере (PX) в size_min:
//          4.2.2.1. TODO
//  4.3. Если в качестве size задано размер (PX):
//      4.3.1. При соотношении (%) в size_min:
//          4.3.1.1. TODO
//      4.3.2. При размере (PX) в size_min:
//          4.3.2.1. TODO
