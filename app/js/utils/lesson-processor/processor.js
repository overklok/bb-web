...
export default class LessonPreprocessor {
    constructor() {}

    static processLesson(_lesson) {
    ...
    static processMission(_mission) {
    ...
    static processExercise (_exercise) {
        let exercise = {};
        ...
        exercise.launch_variant     = (exercise.type === 6) ? 2 : exercise.launch_variant;
        exercise.launch_variant     = exercise.launch_variant === 3 && exercise._launch_variant === 1 ? 1 : exercise.launch_variant;
        exercise.launch_variant     = exercise.launch_variant === 3 && exercise._launch_variant === 0 ? 4 : exercise.launch_variant;
    ...
    static processPopover (_popover) {
        let intro_text = "";
